...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Function NNClassifierL1(Samples_Train,Samples_Test,Labels_Train,Labels_Test)
...
%% INPUT Arguments:
% Samples_Train: d x no of training samples matrix
% Samples_Test:  d x no of testing samples matrix
% Labels_Train:  1 x no of training samples vector including all the labels of the training samples
% Labels_Test:   1 x no of testing samples vector including all the labels of the testing samples
%% OUTPUT Arguments:
% final_accu: the accuracy of this testing round
% PreLabel:      1 x no of testing samples vector including all the predicted labels of the testing samples
%
function [final_accu,PreLabel] = NNClassifierL1(Samples_Train,Samples_Test,Labels_Train,Labels_Test)
